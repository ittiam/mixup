...
exports.help = function() {
  return `
    ...
    If you have any problems, do not hesitate to file an issue:
      ${chalk.cyan('https://github.com/ittiam/mixup/issues/new')}
  `;
};

exports.exampleHelp = function() {
  return `Example from https://github.com/ittiam/mixup/tree/master/examples/ ${output.param(
    'example-path'
  )}`;
};
...
exports.start = function(projectName) {
  ...
  ${chalk.green('https://github.com/ittiam/mixup/issues')}
`;
};
